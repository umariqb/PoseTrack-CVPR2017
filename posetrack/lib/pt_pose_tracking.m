function pt_pose_tracking( expidx,firstidx,nVideos,bRecompute,bVis)
...
%             end
    ...
    detections = MultiScaleDetections.slice(detections, idxs);
...
%             end
            ...
            tempDetections = MultiScaleDetections.slice(wDetections, idx);
        ...
        for fIdx = 1:endIdx
            ...
            fDetections = MultiScaleDetections.slice(wDetections, idx);
...
%         idxs = pwProbSolverTemp(:,3) <  0.6;
        ...
        people = pt_compute_final_posetrack_predictions( out_dets );
